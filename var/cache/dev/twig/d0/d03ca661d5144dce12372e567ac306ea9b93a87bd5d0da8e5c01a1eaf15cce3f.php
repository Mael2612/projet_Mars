...
class __TwigTemplate_f798fb125d8ba3dabae2b6f200317a44aaf79d28473dcfa68045dbf514a33b6b extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"show-article\">
        ...
        <h3 class=\"auteur-subtitle\">
            ...
            <a href=\"";
        // line 14
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("myblog_auteur_show", ["idAuteur" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 14, $this->source); })()), "auteur", [], "any", false, false, false, 14), "id", [], "any", false, false, false, 14)]), "html", null, true);
        echo "\">
                ";
        // line 15
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 15, $this->source); })()), "auteur", [], "any", false, false, false, 15), "fullName", [], "any", false, false, false, 15), "html", null, true);
        echo "
            </a>
        </h3>
        <h4>Publié le ";
        // line 18
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 18, $this->source); })()), "dateCreation", [], "any", false, false, false, 18), "d/m/Y à H\\hi"), "html", null, true);
        echo " </h4>
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_USER")) {
            ...
            echo "            <div>
                <a href=\"";
            // line 26
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("myblog_article_remove", ["idArticle" => twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 26, $this->source); })()), "id", [], "any", false, false, false, 26)]), "html", null, true);
            echo "\">
                    Supprimer
                </a>
                ...
                <a href=\"";
            // line 30
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("myblog_article_update", ["idArticle" => twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 30, $this->source); })()), "id", [], "any", false, false, false, 30)]), "html", null, true);
            echo "\">
                    Éditer
                </a>
            </div>
...
";
    ...
    {
        return array (  147 => 35,  139 => 30,  132 => 26,  129 => 25,  127 => 24,  121 => 21,  115 => 18,  109 => 15,  105 => 14,  99 => 11,  92 => 7,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block innerContent %}
    ...
    <div class=\"show-article\">
        ...
        <h4>Publié le {{ article.dateCreation | date(\"d/m/Y \\à H\\\\hi\")}} </h4>
...
#}", "article/show.html.twig", "/Users/moussaillon/Desktop/symfony/MyBlog/templates/article/show.html.twig");
    }
}
